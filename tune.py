...
from lib.optunatools import config_from_file, full_grid_sampler, get_storage_name, log_attributes, prepare_pruner, save_config, set_max_trials, validation_callback
...
class Objective:
    ...
    def _(self, trial: Union[optuna.trial.FrozenTrial, optuna.trial.FixedTrial]) -> float:
        ...
        config = {**trial.params, **trial.user_attrs.get('fixed_params', {})}
...
if __name__ == "__main__":
    ...
    if run_args.check_best: # see test scores for current best configuration
        ...
        test_config = {**test_trial.params, **test_trial.user_attrs.get('fixed_params', {})}
